...
class Travel extends BaseController
{
    ...
    public function index()
    {
        ...
        foreach ($records as $record) {
            ...
            $table->addRow($nameLink,$record->country,$nameLinks);
...
$parser = \Config\Services::parser(); // tell it about the substitions
 ...
 $fields = [
 'title' => 'RNG esportTeam',
 'heading' => 'RNG esportTeam',
 'footer' => 'YDH'
 ];
...
$record = $places->find($id);
        ...
        $table->setHeading(array_map('ucfirst', $displayHeadings));
       // foreach ($records as $record) {
            $nameLink = '<img src="/image/'.$record['image'].'"height=500px width=500px "">';
...
//->render('oneplace');
 ...
 $fields = [
 'title' => 'RNG esport Team',
 'heading' => 'RNG esport Team',
 'footer' => 'YDH'
 ];
